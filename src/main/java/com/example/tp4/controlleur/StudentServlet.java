package com.example.tp4.controlleur;
...
import com.example.tp4.dao.StudentDao;
import com.example.tp4.model.Student;
    ...
    public class StudentServlet extends HttpServlet {
        ...
        private void search(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            List<Student> search = studentDao.selectStudentName(lastName);
            request.setAttribute("listStudent", search);
